  ...
  return (
    <section className="max-w-7xl mx-auto px-4 mt-10">
      <div className="flex flex-col lg:flex-row border border-gray-200 bg-white">
        ...
        {/* Partie gauche — Journal */}
        <div className="flex flex-col md:flex-row flex-1">

          {/* Couverture */}
          <div className="p-4 flex flex-col items-center justify-center border-b md:border-b-0 md:border-r border-gray-200 md:w-[160px]">
            <Image
              src={cover}
        ...
        {/* Partie droite — Mockup + WhatsApp */}
        <div className="flex flex-col sm:flex-row lg:flex-col lg:w-[400px] border-t lg:border-t-0 lg:border-l border-gray-200">

          {/* Mockup multi-appareils */}
          <div className="relative flex-1 min-h-[200px] sm:min-h-[220px] overflow-hidden bg-gray-50">
            <Image
              src="/images/journal-digital.jpg"
              alt="L'Economie disponible sur tous vos appareils"
              fill
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex flex-col items-center justify-center p-4 text-white text-center hover:opacity-90 transition"
            style={{ backgroundColor: "#075E54" }}
          >
            <div className="bg-white/10 rounded-full px-3 py-0.5 mb-2 flex items-center gap-1.5">
              ...
              <span className="text-[9px] font-bold uppercase tracking-widest">L&apos;ECONOMIE</span>
            </div>
            <svg width="36" height="36" viewBox="0 0 24 24" fill="white" className="mb-2 drop-shadow">
            ...
            <p className="text-[9px] opacity-80 mb-2 leading-snug">Suivez l&apos;actualité économique en temps réel</p>
